...
### Method 2 (same correlation data, different visualisation styles)
```{r}
...
sample_maha_updated2 <- sample_maha_updated2[-c(19:20)]
```
...
sample_maha_updated <- sample_maha_updated[-c(19:20)]
sample_maha <-sample_maha[-c(19:20)]
```
